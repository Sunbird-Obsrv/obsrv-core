package org.sunbird.obsrv.extractor.domain

case class Actor(id: String, `type`: String)

case class EventContext(channel: String, env: String, sid: String, did: String, pdata: Pdata, cdata: Seq[AnyRef])
...
case class LogEvent(actor: Actor, eid: String, edata: EData, ver: String = "3.0", syncts: Long, ets: Long = System.currentTimeMillis(),
                    context: EventContext, mid: String, `object`: Object, tags: Seq[AnyRef])