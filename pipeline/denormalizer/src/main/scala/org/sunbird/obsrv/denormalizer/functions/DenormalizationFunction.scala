...
import org.sunbird.obsrv.denormalizer.`type`.{ContentDenormalization, DeviceDenormalization, DialcodeDenormalization, LocationDenormalization, UserDenormalization}
