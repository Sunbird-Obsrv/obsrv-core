...
object ErrorConstants extends Enumeration {
  ...
  case class ErrorValue(errorCode: String, errorMsg: String, errorReason: String)
  protected final def ErrorInternalValue(errorCode: String, errorMsg: String, errorReason: String): ErrorValue = {
